...
<div class="<?php print $classes; ?>">
  ...
  <?php elseif ($empty): ?>
	...
	function resizeContentHeight() {
		var bottomLogo = parseInt($('#logo_container').css('bottom').replace('px',''));
		var marginSubcontainer = parseInt($('#subcontainer').css('margin-top').replace('px',''));
		var paddingSubcontainer = parseInt($('#subcontainer').css('padding-bottom').replace('px',''));
		var minHeight = $(window).height() - bottomLogo - marginSubcontainer - paddingSubcontainer + 13;
		minHeight = (minHeight < 289) ? 289 : minHeight;
		$('.view-empty .careers-content-container').css({'min-height': minHeight});
		$('#right_content_container').css({'display':'none'});
	}
</script>
<div id="tabs" class="careers-content-container">
	...
	<div id="title">
		<h1 class="helvetica"><?php print t($empty); ?></h1><br />
	</div>
