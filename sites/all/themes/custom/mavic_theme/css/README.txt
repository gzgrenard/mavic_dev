...
To use these stylesheets, rename the files and mavic_theme with the name of your theme.
...
mavic_theme-alpha-default-narrow.css  
...
mavic_theme-alpha-default-normal.css
...
mavic_theme-alpha-default-wide.css
