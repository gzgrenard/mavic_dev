...
?>
<?php if ($iframe_url) : ?>
  <iframe id="vimeo_<?php print $video_code; ?>" src="<?php print $iframe_url; ?>&amp;player_id=vimeo_<?php print $video_code; ?>&amp;api=1" width="<?php print $width; ?>" height="<?php print $height; ?>" frameborder="0" webkitAllowFullScreen mozallowfullscreen allowFullScreen></iframe>
<?php endif; ?>
