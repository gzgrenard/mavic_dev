...
<div class="webform">
	...
	<p class="intro_newsletter"><?php print $content ?></p>
...
<input type="hidden" id="customstr4" Name="do_field_39_16" value="reg_mavic.com">
<input type="hidden" name='do_redirect' value="http://<?php echo $_SERVER['SERVER_NAME'];?>/<?php print $language->language ?>?newsletterok=1">
...
<div class="form-item">
 <label class="option" for="interest-6"><input type="checkbox" name="do_interest_3" id="interest-6" value="10"   class="form-checkbox" /><?php echo t ('downhill/freeride') ?></label>
</div>
</div>
</div>
