...
?>
<?php if ($video_code) : ?>
  <object id="vimeo_<?php print $video_code; ?>" type="application/x-shockwave-flash" width="<?php print $width; ?>" height="<?php print $height; ?>" data="<?php print $data; ?>">
    ...
    <param name="movie" value="<?php print $data; ?>" />
	<param name="flashvars" value="js_api=1&clip_id=<?php print $video_code; ?>&server=vimeo.com&api=1&player_id=vimeo_<?php print $video_code; ?>" /></object>
<?php endif; ?>
